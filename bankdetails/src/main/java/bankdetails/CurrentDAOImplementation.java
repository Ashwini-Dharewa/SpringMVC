	...
	/*public void retrieve()
	{
		...
		Transaction tx =null;
	      ...
	      try {
	         ...
	         List<CurrentAccount> account = session.createQuery("FROM BankDetails").list(); 
	         for (Iterator<CurrentAccount> iterator = account.iterator(); iterator.hasNext();){
	            CurrentAccount acc = (CurrentAccount) iterator.next(); 
	            System.out.print("Account No: " + acc.getAccNo()); 
	            System.out.print("AccountHolderName : " + acc.getAccName()); 
